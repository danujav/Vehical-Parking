 ...
 * @author danu
 */
public class VehicalDetailsTable extends javax.swing.JFrame {

    /**
     * Creates new form VehicalDetails
     */
    public VehicalDetailsTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ItemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vehical Number", "Vehical Type", "Owner's Name"
            }
        ) {
    ...
    private void showDetailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showDetailsBtnActionPerformed
        ...
        try {
            ArrayList<VehicalModule>itemList= VehicalController.getAllItemForTableFromVehical();
            DefaultTableModel dtm = (DefaultTableModel) ItemTable.getModel();
            dtm.setRowCount(0);
            for (VehicalModule item : itemList) {
                Object[] rowData={item.getVehicalNumber(),item.getVehicalNumber(),item.getVehicalType(), item.getOwnerName()};
                dtm.addRow(rowData);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VehicalDetailsTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
